"""
FP8 (e4m3) emulation for the StripedHyena input projections on Strix Halo / RDNA (and any non-FP8 GPU).
...
runs on ROCm/MPS (and CPU). It is **bit-exact emulation**, not hardware FP8: on

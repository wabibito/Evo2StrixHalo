#!/usr/bin/env python3
"""
Greedy-generation identity test for Evo2StrixHalo, vs upstream's H100 reference.
...
For evo2_1b_base, run with EVO2_FP8_EMULATION=1 to test the FP8 e4m3
...
forward-pass accuracy in scripts/validate_fp8_emulation.py).
    ...
    conda activate Evo2StrixHalo
    python scripts/test_generation.py --model evo2_7b              # vs 89.25%
    EVO2_FP8_EMULATION=1 python scripts/test_generation.py --model evo2_1b_base
"""
...
def main() -> int:
    ...
    fp8 = os.environ.get("EVO2_FP8_EMULATION") == "1"
